...
#ifndef __PUSHSERVANT_H_
#define __PUSHSERVANT_H_
...
namespace otim
{
    ...
    class PushServantPrxCallback: public tars::ServantProxyCallback
    {
    public:
        virtual ~PushServantPrxCallback(){}
    ...
    public:
        ...
        {
            static ::std::string __PushServant_all[]=
            {
                "test"
            };
            auto it = _msg_->response->status.find("TARS_FUNC");
            pair<string*, string*> r = equal_range(__PushServant_all, __PushServant_all+1, (it==_msg_->response->status.end())?_msg_->request.sFuncName:it->second);
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __PushServant_all)
            {
                case 0:
                {
    ...
    typedef tars::TC_AutoPtr<PushServantPrxCallback> PushServantPrxCallbackPtr;

    //callback of promise async proxy for client
    class PushServantPrxCallbackPromise: public tars::ServantProxyCallback
    {
    public:
        virtual ~PushServantPrxCallbackPromise(){}
    public:
        ...
        typedef tars::TC_AutoPtr< PushServantPrxCallbackPromise::Promisetest > PromisetestPtr;

        PushServantPrxCallbackPromise(const tars::Promise< PushServantPrxCallbackPromise::PromisetestPtr > &promise)
        : _promise_test(promise)
        {}
        
        virtual void callback_test(const PushServantPrxCallbackPromise::PromisetestPtr &ptr)
        {
    ...
    protected:
        tars::Promise< PushServantPrxCallbackPromise::PromisetestPtr > _promise_test;
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__PushServant_all, __PushServant_all+1, string(_msg_->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __PushServant_all)
            {
                case 0:
                {
                    ...
                    PushServantPrxCallbackPromise::PromisetestPtr ptr = new PushServantPrxCallbackPromise::Promisetest();
    ...
    typedef tars::TC_AutoPtr<PushServantPrxCallbackPromise> PushServantPrxCallbackPromisePtr;

    /* callback of coroutine async proxy for client */
    class PushServantCoroPrxCallback: public PushServantPrxCallback
    {
    public:
        virtual ~PushServantCoroPrxCallback(){}
    public:
    ...
    typedef tars::TC_AutoPtr<PushServantCoroPrxCallback> PushServantCoroPrxCallbackPtr;

    /* proxy for client */
    class PushServantProxy : public tars::ServantProxy
    {
    public:
        ...
        void async_test(PushServantPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
            ServantProxyThreadData *_pSptd_ = ServantProxyThreadData::getData();
        ...
        tars::Future< PushServantPrxCallbackPromise::PromisetestPtr > promise_async_test(const map<string, string>& context)
        {
            tars::Promise< PushServantPrxCallbackPromise::PromisetestPtr > promise;
            PushServantPrxCallbackPromisePtr callback = new PushServantPrxCallbackPromise(promise);
        ...
        void coro_test(PushServantCoroPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
        ...
        PushServantProxy* tars_hash(uint32_t key)
        {
            return (PushServantProxy*)ServantProxy::tars_hash(key);
        }

        PushServantProxy* tars_consistent_hash(uint32_t key)
        {
            return (PushServantProxy*)ServantProxy::tars_consistent_hash(key);
        }

        PushServantProxy* tars_open_trace(bool traceParam = false)
        {
            return (PushServantProxy*)ServantProxy::tars_open_trace(traceParam);
        }

        PushServantProxy* tars_set_timeout(int msecond)
        {
            return (PushServantProxy*)ServantProxy::tars_set_timeout(msecond);
        }

        static const char* tars_prxname() { return "PushServantProxy"; }
    };
    typedef tars::TC_AutoPtr<PushServantProxy> PushServantPrx;

    /* servant for server */
    class PushServant : public tars::Servant
    {
    public:
        virtual ~PushServant(){}
    ...
    public:
        ...
        {
            static ::std::string __otim__PushServant_all[]=
            {
                "test"
            };

            pair<string*, string*> r = equal_range(__otim__PushServant_all, __otim__PushServant_all+1, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __otim__PushServant_all)
            {
                case 0:
                {
                    tars::TarsInputStream<tars::BufferReader> _is;
