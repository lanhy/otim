...
SingleChatServer g_app;

/////////////////////////////////////////////////////////////////
void
SingleChatServer::initialize()
{
    ...
    addServant<SingleChatServantImp>(ServerConfig::Application + "." + ServerConfig::ServerName + ".SingleChatServantObj");
}
/////////////////////////////////////////////////////////////////
void
SingleChatServer::destroyApp()
{
