...
BizMsgServer::initialize()
{
    ...
    addServant<BizMsgServantImp>(ServerConfig::Application + "." + ServerConfig::ServerName + ".BizMsgServantObj");
}
/////////////////////////////////////////////////////////////////
void
BizMsgServer::destroyApp()
{
