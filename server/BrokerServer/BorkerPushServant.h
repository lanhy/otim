...
#ifndef __BORKERPUSHSERVANT_H_
#define __BORKERPUSHSERVANT_H_
...
namespace otim
{
    ...
    class BorkerPushServantPrxCallback: public tars::ServantProxyCallback
    {
    public:
        virtual ~BorkerPushServantPrxCallback(){}
    ...
    public:
        ...
        {
            static ::std::string __BorkerPushServant_all[]=
            {
                "test"
            };
            auto it = _msg_->response->status.find("TARS_FUNC");
            pair<string*, string*> r = equal_range(__BorkerPushServant_all, __BorkerPushServant_all+1, (it==_msg_->response->status.end())?_msg_->request.sFuncName:it->second);
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __BorkerPushServant_all)
            {
                case 0:
                {
    ...
    typedef tars::TC_AutoPtr<BorkerPushServantPrxCallback> BorkerPushServantPrxCallbackPtr;

    //callback of promise async proxy for client
    class BorkerPushServantPrxCallbackPromise: public tars::ServantProxyCallback
    {
    public:
        virtual ~BorkerPushServantPrxCallbackPromise(){}
    public:
        ...
        typedef tars::TC_AutoPtr< BorkerPushServantPrxCallbackPromise::Promisetest > PromisetestPtr;

        BorkerPushServantPrxCallbackPromise(const tars::Promise< BorkerPushServantPrxCallbackPromise::PromisetestPtr > &promise)
        : _promise_test(promise)
        {}
        
        virtual void callback_test(const BorkerPushServantPrxCallbackPromise::PromisetestPtr &ptr)
        {
    ...
    protected:
        tars::Promise< BorkerPushServantPrxCallbackPromise::PromisetestPtr > _promise_test;
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__BorkerPushServant_all, __BorkerPushServant_all+1, string(_msg_->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __BorkerPushServant_all)
            {
                case 0:
                {
                    ...
                    BorkerPushServantPrxCallbackPromise::PromisetestPtr ptr = new BorkerPushServantPrxCallbackPromise::Promisetest();
    ...
    typedef tars::TC_AutoPtr<BorkerPushServantPrxCallbackPromise> BorkerPushServantPrxCallbackPromisePtr;

    /* callback of coroutine async proxy for client */
    class BorkerPushServantCoroPrxCallback: public BorkerPushServantPrxCallback
    {
    public:
        virtual ~BorkerPushServantCoroPrxCallback(){}
    public:
    ...
    typedef tars::TC_AutoPtr<BorkerPushServantCoroPrxCallback> BorkerPushServantCoroPrxCallbackPtr;

    /* proxy for client */
    class BorkerPushServantProxy : public tars::ServantProxy
    {
    public:
        ...
        void async_test(BorkerPushServantPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
            ServantProxyThreadData *_pSptd_ = ServantProxyThreadData::getData();
        ...
        tars::Future< BorkerPushServantPrxCallbackPromise::PromisetestPtr > promise_async_test(const map<string, string>& context)
        {
            tars::Promise< BorkerPushServantPrxCallbackPromise::PromisetestPtr > promise;
            BorkerPushServantPrxCallbackPromisePtr callback = new BorkerPushServantPrxCallbackPromise(promise);
        ...
        void coro_test(BorkerPushServantCoroPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
        ...
        BorkerPushServantProxy* tars_hash(uint32_t key)
        {
            return (BorkerPushServantProxy*)ServantProxy::tars_hash(key);
        }

        BorkerPushServantProxy* tars_consistent_hash(uint32_t key)
        {
            return (BorkerPushServantProxy*)ServantProxy::tars_consistent_hash(key);
        }

        BorkerPushServantProxy* tars_open_trace(bool traceParam = false)
        {
            return (BorkerPushServantProxy*)ServantProxy::tars_open_trace(traceParam);
        }

        BorkerPushServantProxy* tars_set_timeout(int msecond)
        {
            return (BorkerPushServantProxy*)ServantProxy::tars_set_timeout(msecond);
        }

        static const char* tars_prxname() { return "BorkerPushServantProxy"; }
    };
    typedef tars::TC_AutoPtr<BorkerPushServantProxy> BorkerPushServantPrx;

    /* servant for server */
    class BorkerPushServant : public tars::Servant
    {
    public:
        virtual ~BorkerPushServant(){}
    ...
    public:
        ...
        {
            static ::std::string __otim__BorkerPushServant_all[]=
            {
                "test"
            };

            pair<string*, string*> r = equal_range(__otim__BorkerPushServant_all, __otim__BorkerPushServant_all+1, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __otim__BorkerPushServant_all)
            {
                case 0:
                {
                    tars::TarsInputStream<tars::BufferReader> _is;
