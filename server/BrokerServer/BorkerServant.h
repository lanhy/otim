...
#ifndef __BORKERSERVANT_H_
#define __BORKERSERVANT_H_
...
namespace otim
{
    ...
    class BorkerServantPrxCallback: public tars::ServantProxyCallback
    {
    public:
        virtual ~BorkerServantPrxCallback(){}
    ...
    public:
        ...
        {
            static ::std::string __BorkerServant_all[]=
            {
                "test"
            };
            auto it = _msg_->response->status.find("TARS_FUNC");
            pair<string*, string*> r = equal_range(__BorkerServant_all, __BorkerServant_all+1, (it==_msg_->response->status.end())?_msg_->request.sFuncName:it->second);
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __BorkerServant_all)
            {
                case 0:
                {
    ...
    typedef tars::TC_AutoPtr<BorkerServantPrxCallback> BorkerServantPrxCallbackPtr;

    //callback of promise async proxy for client
    class BorkerServantPrxCallbackPromise: public tars::ServantProxyCallback
    {
    public:
        virtual ~BorkerServantPrxCallbackPromise(){}
    public:
        ...
        typedef tars::TC_AutoPtr< BorkerServantPrxCallbackPromise::Promisetest > PromisetestPtr;

        BorkerServantPrxCallbackPromise(const tars::Promise< BorkerServantPrxCallbackPromise::PromisetestPtr > &promise)
        : _promise_test(promise)
        {}
        
        virtual void callback_test(const BorkerServantPrxCallbackPromise::PromisetestPtr &ptr)
        {
    ...
    protected:
        tars::Promise< BorkerServantPrxCallbackPromise::PromisetestPtr > _promise_test;
    ...
    public:
        virtual int onDispatch(tars::ReqMessagePtr _msg_)
        {
            ...
            pair<string*, string*> r = equal_range(__BorkerServant_all, __BorkerServant_all+1, string(_msg_->request.sFuncName));
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __BorkerServant_all)
            {
                case 0:
                {
                    ...
                    BorkerServantPrxCallbackPromise::PromisetestPtr ptr = new BorkerServantPrxCallbackPromise::Promisetest();
    ...
    typedef tars::TC_AutoPtr<BorkerServantPrxCallbackPromise> BorkerServantPrxCallbackPromisePtr;

    /* callback of coroutine async proxy for client */
    class BorkerServantCoroPrxCallback: public BorkerServantPrxCallback
    {
    public:
        virtual ~BorkerServantCoroPrxCallback(){}
    public:
    ...
    typedef tars::TC_AutoPtr<BorkerServantCoroPrxCallback> BorkerServantCoroPrxCallbackPtr;

    /* proxy for client */
    class BorkerServantProxy : public tars::ServantProxy
    {
    public:
        ...
        void async_test(BorkerServantPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
            ServantProxyThreadData *_pSptd_ = ServantProxyThreadData::getData();
        ...
        tars::Future< BorkerServantPrxCallbackPromise::PromisetestPtr > promise_async_test(const map<string, string>& context)
        {
            tars::Promise< BorkerServantPrxCallbackPromise::PromisetestPtr > promise;
            BorkerServantPrxCallbackPromisePtr callback = new BorkerServantPrxCallbackPromise(promise);
        ...
        void coro_test(BorkerServantCoroPrxCallbackPtr callback,const map<string, string>& context = TARS_CONTEXT())
        {
            tars::TarsOutputStream<tars::BufferWriterVector> _os;
            std::map<string, string> _mStatus;
        ...
        BorkerServantProxy* tars_hash(uint32_t key)
        {
            return (BorkerServantProxy*)ServantProxy::tars_hash(key);
        }

        BorkerServantProxy* tars_consistent_hash(uint32_t key)
        {
            return (BorkerServantProxy*)ServantProxy::tars_consistent_hash(key);
        }

        BorkerServantProxy* tars_open_trace(bool traceParam = false)
        {
            return (BorkerServantProxy*)ServantProxy::tars_open_trace(traceParam);
        }

        BorkerServantProxy* tars_set_timeout(int msecond)
        {
            return (BorkerServantProxy*)ServantProxy::tars_set_timeout(msecond);
        }

        static const char* tars_prxname() { return "BorkerServantProxy"; }
    };
    typedef tars::TC_AutoPtr<BorkerServantProxy> BorkerServantPrx;

    /* servant for server */
    class BorkerServant : public tars::Servant
    {
    public:
        virtual ~BorkerServant(){}
    ...
    public:
        ...
        {
            static ::std::string __otim__BorkerServant_all[]=
            {
                "test"
            };

            pair<string*, string*> r = equal_range(__otim__BorkerServant_all, __otim__BorkerServant_all+1, _current->getFuncName());
            if(r.first == r.second) return tars::TARSSERVERNOFUNCERR;
            switch(r.first - __otim__BorkerServant_all)
            {
                case 0:
                {
                    tars::TarsInputStream<tars::BufferReader> _is;
